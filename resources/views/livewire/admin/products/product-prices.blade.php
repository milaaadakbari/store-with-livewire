...
{{--    <a href="{{route('admin.create.product')}}" type="button" class="btn btn-danger mb-4 w-[300px]">--}}
        ...
        <div class="table-responsive">
            <table>
                ...
                <tr>
                    ...
                    <th class="text-center">گارنتی</th>
                ...
                @foreach($this->productPrices as $index => $productPrice)
                    <tr>
                        ...
                        <td class="flex items-center justify-center p-3 text-center">
                            <a href="{{route('admin.edit.product',$productPrice->id)}}" class="m-4" x-tooltip="ویرایش">
                            ...
                            <button wire:click="$dispatch('delete-product', { productPrice_id : {{$productPrice->id}} })" type="button" x-tooltip="حذف">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
