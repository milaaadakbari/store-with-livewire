                        ...
                        <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                            <button wire:click="restoreRow({{$category->id}})"  type="button" x-tooltip="بازآوری">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                    ...
                                    19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031
                                     9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99" />
                                </svg>

                            </button>
                            <button wire:click="$dispatch('hard_delete-category', { category_id : {{$category->id}} })" type="button" x-tooltip="حذف کامل">
...
@script
<script>
    Livewire.on('hard_delete-category',(event)=>{
        Swal.fire({
            ...
            if (result.isConfirmed){
                Livewire.dispatch('hard_destroy-category',{ category_id : event.category_id})
                Swal.fire({
                    title: "حذف انجام شد",
                    icon: "success"
                });
